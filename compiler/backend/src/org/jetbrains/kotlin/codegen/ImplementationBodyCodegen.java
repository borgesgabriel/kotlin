...
public class ImplementationBodyCodegen extends ClassBodyCodegen {
    ...
    public ImplementationBodyCodegen(
        ...
        delegationFieldsInfo = getDelegationFieldsInfo(myClass.getDelegationSpecifiers());
    }
    ...
    @Override
    protected void generateDerivative() {
        if (isInterface(descriptor) && !isLocal) {
            ...
            ClassContext defaultImplsContext = parentContext.intoDefaultImplClass(descriptor, (ClassContext) context, state);
