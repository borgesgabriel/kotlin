...
fun populateCompanionBackingFieldNamesToOuterContextIfNeeded(companion: KtObjectDeclaration, outerContext: FieldOwnerContext<*>, state: GenerationState) {
    ...
    properties.forEach {
        ...
        assert(variableDescriptor is PropertyDescriptor) { "Property " + it.text + " should have a property descriptor: " + variableDescriptor }
        outerContext.getFieldName(variableDescriptor as PropertyDescriptor, it.hasDelegate())
    }
