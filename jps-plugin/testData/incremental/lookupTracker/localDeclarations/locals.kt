...
/*p:local.declarations*/fun f(p: /*p:local.declarations*/Any) {
    ...
    localFun()
    1./*p:local.declarations p:bar p:java.lang p:kotlin p:kotlin.annotation p:kotlin.jvm p:kotlin.collections p:kotlin.ranges p:kotlin.sequences p:kotlin.text p:kotlin.io*/localExtFun()
