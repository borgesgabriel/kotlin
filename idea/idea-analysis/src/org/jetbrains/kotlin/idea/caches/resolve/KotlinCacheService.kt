...
public class KotlinCacheService(val project: Project) {
    ...
    public fun getSuppressionCache() : KotlinSuppressCache = _kotlinSuppressCache.value
    ...
    private val _kotlinSuppressCache: CachedValue<KotlinSuppressCache> = CachedValuesManager.getManager(project).createCachedValue({
